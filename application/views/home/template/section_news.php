			...
			<div class="row">
				<div class="col-md-12">
					<section class="home-featured-cat" id="category-<?=@$section_news['parent_cat']->id?>">
						...
						<div class="vc_separator wpb_content_element vc_separator_align_center vc_sep_width_60 vc_sep_pos_align_center vc_sep_color_orange vc_separator-has-text"><span class="vc_sep_holder vc_sep_holder_l"><span class="vc_sep_line"></span></span>
						...
						<div class="content row clearfix">
							<div class="col-md-8 col-lg-8 col-xs-12">
								<div class="box-articles clearfix row">
									...
									<?php if ($section_news['news_item']) {foreach ($section_news['news_item'] as $item) {
										//print_r($item[0]->alias);
										?>
									...
									<div class="col-md-7 col-sm-7">
										<div class="cat-smaller">
											...
											<ul class="row clearfix">
												<? if ($section_news['child_cat']) foreach ($section_news['child_cat'] as $item) {?>
												<li class="col-md-6 col-sm-12 col-xs-12"><a href="<?=base_url('category/').$section_news['parent_cat']->alias.'/'.$item->alias?>"><i class="fa fa-angle-right"></i> <?=$item->title?></a></li>
												<?php } ?>
											</ul>
										</div>
									</div>
