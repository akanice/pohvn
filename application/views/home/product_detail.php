		...
		<div class="container">
			<div class="row clearfix">
				...
				<div class="col-md-9 product-detail">
					<div class="row clearfix productshow">
						...
						<div class="col-md-7">
							<div class="content">
								...
								<div class="sku">Manufacture: <span class="hl"><?php if (isset($brand_name) && ($brand_name != '')) {echo $brand_name->name;}?></span></div>
								<div class="sku"><?=$this->lang->line("productcode");?> (SKU): <span class="hl"><?=$prod_detail[0]->sku?></span></div>
								<div class="price"><?=$this->lang->line("price");?>: <span class="hl"><?=number_format($prod_detail[0]->reg_price,0,',','.')?> VNĐ </span></div>
						...
						<div class="col-md-12 productshow prod-info">
							<ul class="nav nav-tabs" role="tablist">
								...
								<!--<li role="presentation"><a href="#tab2" aria-controls="newest" role="tab" data-toggle="tab" class="tab-label"><?=$this->lang->line("engineeringdetail");?></a></li>-->
					...
					<div class="prod-accessories productshow">
						<h4 class="heading"><span><?=$this->lang->line("accessories");?></span></h4>
						<div class="row clearfix">
							<?php if ($accessory == '' or $accessory == null) { ?>
							<div class="col-md-12"><h5><?=$this->lang->line("noproduct");?></h5></div>
							<?php } else { foreach ($accessory as $item) { ?>
							<div class="col-md-2">
					...
					<div class="product-related productshow">
						...
						<div class="row clearfix">
							<?php if ($prod_related == '' or $prod_related == null) { ?>
							<div class="col-md-12"><h5><?=$this->lang->line("noproduct");?></h5></div>
							<?php } else { foreach ($prod_related as $item) {?>
							<div class="col-md-3">
								<div class="block item center">
									<a href="<?=base_url('san-pham/chi-tiet/'.$item->alias)?>">
										<img src="<?=base_url($item->thumb)?>" class="img-holder thumb">
										<h5><?=$item->name?></h5>
										<p class="price"><?=number_format($item->reg_price,0,',','.')?></p>
									</a>
								</div>
							</div>
							<?php } } ?>
