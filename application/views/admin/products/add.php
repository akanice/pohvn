					...
					<div class="content">
                        <form class="form-horizontal" method="POST" enctype="multipart/form-data">
								...
								<div class="col-sm-8">
									<div class="" style="overflow-y: scroll;height: 250px">
										...
										<label class="checkbox">
											<input type="checkbox" name="category[]" data-toggle="checkbox" value="<?=@$cat_item['id']?>"> <?=@$indent.$cat_item['name'] ?>
										</label>
										<?php } ?>
									</div>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="reg_price" required=""/>
								</div>
							</div>
							<div class="form-group">
